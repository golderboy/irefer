    ...
    <div class="card">
        ...
        <div id="search"> 
            ...
            $form = ActiveForm::begin([
                        'method'=>'Get',
                        'action'=>Url::to(['/ireport/ireport/rpt-out-001a']),
                    ]);
                    echo "<div class='row'>";
                    ...
                    echo "</div>";*/
                    echo "<div class='col col-md-3'>";
                    echo '<label class="control-label">ระดับความรุนแรง</label>';
                    echo Select2::widget([
                        'name' => 'strength',
                ...
                echo "</div>";
                    ...
                    if (!Yii::$app->request->isAjax){
                        ...
                        Html::a('ล้างข้อมูลค้นหา',['/ireport/ireport/rpt-out-001a'],['class'=>'btn btn-danger','data-pjax' => '0']);
                    }
                    echo "</div>";
